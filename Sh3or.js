...
var me_user1 = setInterval(function () {
  if (myid != null) {
    ...
    $("div#users .uzr:contains('شُعور') .My_vedio1").click(function () {
      $("#movon1").show();
